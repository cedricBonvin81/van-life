    ...
    <div class="bg-white min-h-screen">
        <section class="relative h-[70vh] flex items-center justify-center bg-black overflow-hidden">
            <div class="relative z-10 text-center px-6">
                <h1
                    class="hero-title text-5xl md:text-8xl font-black text-white mb-6 uppercase tracking-tighter text-shadow-xl opacity-0">
                    L'énergie <br /> Nomade
                </h1>
                <p
    ...
    if (process.client) {
        ...
        ctx = gsap.context(() => {
            ...
            const createAnim = (el, xPos) => {
                gsap.fromTo(el, { opacity: 0, x: xPos }, {
            ...
            createAnim(".elec-img-1", -60); createAnim(".elec-text-1", 60)
            createAnim(".elec-text-2", -60); createAnim(".elec-img-2", 60)
            createAnim(".elec-img-3", -60); createAnim(".elec-text-3", 60)
            createAnim(".elec-text-4", -60); createAnim(".elec-img-4", 60)
